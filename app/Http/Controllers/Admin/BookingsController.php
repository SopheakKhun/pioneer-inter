...
class BookingsController extends Controller
{
    ...
    public function create()
    {
        ...
        $requestings = \App\Requesting::get()->pluck('desc', 'id')->prepend(trans('global.app_please_select'), '');

        return view('admin.bookings.create', compact('users', 'requestings'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.bookings.edit', compact('booking', 'users', 'requestings'));
    }
    ...
    public function show($id)
    {
        ...
        $users = \App\User::get()->pluck('name', 'id')->prepend(trans('global.app_please_select'), '');
        $requestings = \App\Requesting::get()->pluck('desc', 'id')->prepend(trans('global.app_please_select'), '');$jobsheets = \App\Jobsheet::where('booking_id', $id)->get();

        $booking = Booking::findOrFail($id);

        return view('admin.bookings.show', compact('booking', 'jobsheets'));
    }
