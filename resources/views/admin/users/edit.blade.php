...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('lname', trans('global.users.fields.lname').'*', ['class' => 'control-label']) !!}
                    {!! Form::text('lname', old('lname'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('lname'))
                        <p class="help-block">
                            {{ $errors->first('lname') }}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('address', trans('global.users.fields.address').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('suburb', trans('global.users.fields.suburb').'', ['class' => 'control-label']) !!}
                    {!! Form::text('suburb', old('suburb'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('state', trans('global.users.fields.state').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('postcode', trans('global.users.fields.postcode').'', ['class' => 'control-label']) !!}
